...
💻 Frontend-разработчик с любовью к VUE, React и TypeScript 
👨‍💻 Пишу и строю команды, которые пишут на **Vue**, **React**, **Nuxt**, **Next**, **TypeScript** и не только  
🚀 Люблю хорошо выстроенные UI, DX и масштабируемую архитектуру  
📚 Менторю, рефакторю, продвигаю лучшие практики  
💡 Увлекаюсь дизайном систем и инженерным менеджментом
